...
Ein Charakterbogen-Editor für die **World of Darkness** Rollenspielsysteme. Entwickelt mit React und Tailwind CSS für
eine moderne Benutzeroberfläche im Gothic-Design.
...
### Version 1.6 (28.03.2026)
- **Refactoring
  - Weitere Umstrukturierung des Codes
- **Werewolf
  - Charaakter-Erstellung für Werewolf

### Version 1.5 (23.03.2026)
...
Das Projekt verwendet Standard-React-Patterns mit funktionalen Komponenten und Hooks. Spieldaten sind in
`src/data/sharedData.js` zentral verwaltet.
...
MIT License. World of Darkness ist ein Warenzeichen von Paradox Interactive. Dieses Projekt ist ein inoffizielles
Fan-Tool.

## Beitragen

Pull Requests sind willkommen. Bei größeren Änderungen bitte zuerst ein Issue erstellen, um die geplanten Änderungen zu
diskutieren.
