...
export const MeritsFlawsModal = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
            <div
                className={`w-full max-w-2xl rounded-lg shadow-2xl ${colors.bg} border ${colors.border} ${colors.text}`}>
                {/* Header */}
                    ...
                    {currentList.length === 0 ? (
                        ...
                        <div className="space-y-3">
                            {currentList.map((item) => {
                                ...
                                return (
                                    <div key={item.name}
                                         className={`flex justify-between items-start border-b ${colors.border} pb-2`}>
