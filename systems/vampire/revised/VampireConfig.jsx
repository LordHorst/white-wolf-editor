...
import {getClanDisciplines, VampireData, VampireFlaws, VampireMerits, getEmptyVampire} from './vampireData';
...
export const vampireConfig = {
    ...
    renderRules: () => (
        <>
            ...
            <p><strong>✨ Vorteile</strong><br/><strong>Disziplinen:</strong> 3 Punkte. <strong>Hintergründe:</strong> 5
                Punkte. <strong>Tugenden:</strong> 7 Zusatzpunkte (Gesamt max. 10).</p>
            <p><strong>🧛 Nosferatu-Schwäche</strong><br/>Erscheinungsbild wird auf 0 gesetzt und zählt nicht zu den
                Punktelimits.</p>
            <p><strong>💖 Menschlichkeit &amp; Willenskraft</strong><br/>Menschlichkeit ≥ Gewissen + Selbstbeherrschung.
                Willenskraft ≥ Mut.</p>
            <p><strong>⭐ Freebies</strong><br/>15 Punkte. Attribut 5, Fähigkeit 2, Disziplin 7, Hintergrund 1, Tugend 2,
                Menschlichkeit 2, Willenskraft 1 pro Punkt.</p>
        </>
    ),
